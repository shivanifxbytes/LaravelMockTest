          ...
          <td><table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td><table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td align="left"><h1 style="font-family: Helvetica, Arial, sans-serif; font-size: 28px; font-weight:normal; color: #2C3E50; margin:0; mso-line-height-rule:exactly;">Hello</h1></td>
                    </tr>
                    <tr>
                      <td align="center" height="25" style="height:25px; font-size: 0;">&nbsp;</td>
                    </tr>
                    <tr>
                      <td align="left" style="font-family: Helvetica, Arial, sans-serif; font-size: 16px; line-height: 25px; color: #2C3E50;">Congratulations! You have successfully singed up. Please verify your email address by clicking below Verification link.<br>
                        </td>
                    </tr>
                    <tr>
                      <td align="center" height="25" style="height:25px; font-size: 0;">&nbsp;</td>
                    ...
                    <tr>
                        <td align="center" style="border-radius: 3px;" bgcolor="#ffc107"><a href="{{$verifyUrl}}" title="Click Here" target="_blank" style="font-family: Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 3px; padding: 15px 25px; border: 1px solid #ffc107; display: inline-block;width: 90%;" class="mobile-btn">Click Here</a></td>
                    </tr>
                  </table></td>
              </tr>
              <tr>
              ...
              <tr>
                <td align=""><table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td align="">
                      <table role="presentation" border="0" cellspacing="0" cellpadding="0" class="mobile-btn-container">
                          <tr>
                            <td style="font-family: Helvetica, Arial, sans-serif; font-size: 16px; line-height: 25px; color: #2C3E50;">
